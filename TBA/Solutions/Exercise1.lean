...
example : ¬False := 
  fun hfalse => hfalse  -- or simply `id`, the identity function
...
-- Yes, we can elide parentheses around `fun` even in argument position.
-- You be the judge of whether you find that readable or not.
